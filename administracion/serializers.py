...
class AuthUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            'group_id', 'menus_ids', 'permissions_ids', 'estado', 
            'created_by_id', 'updated_by_id','type','type_identification_document','identification_document','ci_complement','ci_expedited','cellphone'
        )
