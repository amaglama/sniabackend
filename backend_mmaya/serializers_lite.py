...
from programas.models import Proyectos
...
class SectorSelectSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Sector
        fields = ('id', 'nombre','viceministerio', 'viceministerio_id', 'sector_id')
...
class TipoProyectoSelectSerializer(BaseCrudSerializer):
    class Meta:
        model=TipoProyecto
        fields=('id','nombre','sub_sector_id')
...
class SectorDetalladoSelectSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        data['programas'] = ProgramasSelectSerializer(instance.programas, many=True).data
