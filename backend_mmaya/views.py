...
class UpsertGetOneToOneViewSet(generics.RetrieveUpdateAPIView):
    ...
    #view para files archivos renca

def protected_media_view(request, file_path):
    # Asegúrate de que el usuario esté autenticado
    if not request.user.is_authenticated:
        return Http404("No tienes acceso a este archivo.")
    ...
    return FileResponse(open(file_full_path, 'rb'), content_type='application/octet-stream')
